export const Test_Games = [
  {
    ...
    category: "Solo",
    imageUrl:
      "https://cf.geekdo-images.com/ecO5eAd3RkctQ0-Tbqv37Q__imagepagezoom/img/4qrc97XsKmnL5-0GVy5VIg197-Q=/fit-in/1200x900/filters:no_upscale():strip_icc()/pic5428723.jpg",
    summary: `Under Falling Skies is a solo game with a multi-mission campaign. In each mission, you take charge of defending a besieged city.
    ...
    Expand your underground base to gain access to more powerful actions, allowing you to shoot down enemy ships or deploy robots to increase your workforce, but dont forget to work on your research and watch your energy supply.
  ...
  },
  {
    ...
    category: "Solo",
    imageUrl:
      "https://cf.geekdo-images.com/1rf6L2NfsM4LTIH9KwHJkg__imagepage/img/J8yKO0HTRpmJIUPcDC_EzU0voW4=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6520341.jpg",
    summary: `Playing on a famous horror movie trope, Final Girl is a solitaire-only game that puts the player in the shoes of a female protagonist who must kill the slasher if she wants to survive.
  ...
  },
  {
    ...
    category: "Solo",
    imageUrl:
      "https://cf.geekdo-images.com/Z6MMX39UEAZT3-f-DlnHsA__imagepage/img/-xU8fQ3jqb78ypF1vpaAw6lCs_Y=/fit-in/900x600/filters:no_upscale():strip_icc()/pic8114705.jpg",
  summary: `Gloomhaven: Buttons & Bugs is a solo play game, with an original campaign story written by Isaac Childres, that features a playstyle similar to Gloomhaven in a fraction of the size.
  ...
  summary: `You are Taylor Minde, rookie pilot of the Force’s Outer Rim. After a crucial battle you are stranded far away from your fleet, lost and alone. With resources running low you jump through warp gate after warp gate hoping to find the right combination home.
  ...
  summary: `Pandemic Legacy is a co-operative campaign game, with an overarching story-arc played through 12-24 sessions, depending on how well your group does at the game. At the beginning, the game starts very similar to basic Pandemic, in which your team of disease-fighting specialists races against the clock to travel around the world, treating disease hotspots while researching cures for each of four plagues before they get out of hand.
    ...
    },
  {
    ...
    age: 5,
    imageUrl:
      "https://cf.geekdo-images.com/v0FCI-wY8YlPn39XKd3F8w__imagepage/img/39PdG9Yp8x0iHvgBe2gQeZ5Z_WQ=/fit-in/900x600/filters:no_upscale():strip_icc()/pic2401324.jpg",
  summary: `Mrs. Plumpert's prized pot pie has gone missing, and now it's a chicken chase to crack the case!
  ...
  summary: `Carcassonne is a tile-placement game in which the players draw and place a tile with a piece of southern French landscape on it. The tile might feature a city, a road, a cloister, grassland or some combination thereof, and it must be placed adjacent to tiles that have already been played, in such a way that cities are connected to cities, roads to roads, etcetera. Having placed a tile, the player can then decide to place one of their meeples on one of the areas on it: on the city as a knight, on the road as a robber, on a cloister as a monk, or on the grass as a farmer. When that area is complete, that meeple scores points for its owner.
  ...
  summary: `The rules of "Red" are simple: highest card wins! But "Red" is just one of seven games you'll be playing in Red7, and if you're not winning the current game at the end of your turn, you're out! The last person standing wins the round.
